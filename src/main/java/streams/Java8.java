...
public class Java8 {
    ...
    private static int getCountLength3StringUsingJava7(List<String> strings) {
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        count = getCountLength3StringUsingJava7(strings);
        ...
        System.out.println("Sum all of numbers : " + getSum(integers));
        ...
        System.out.println("Sum all of numbers : " + stats.getSum());
